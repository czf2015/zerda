<template>
  <div :id="componentId">
    ...
    >
      ...
      <el-table-column prop="title" label="标题" width="180" align="left" />
      <el-table-column prop="slug" label="标识" width="180" align="left" />
    ...
    <RemoveDialog
      ref="RemoveDialog"
      :removeConfirm="handelTableData"
      :propData="{ title: '删除服务', content: '您确认删除此服务吗' }"
    />
  </div>
</template>
    ...
    handleMove(type, index) {
      ...
      this.$nextTick(() => {
        ...
        this.timer = setTimeout(() => {
          tableRows[index + type].className = tableRows[index].className =
